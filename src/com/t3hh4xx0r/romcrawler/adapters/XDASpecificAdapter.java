...
public class XDASpecificAdapter extends BaseAdapter {
	...
	String ident;
	 ...
	 public XDASpecificAdapter(Context context, ArrayList<TitleResults> results, String site) {
	 ...
	 public View getView(final int position, View convertView, ViewGroup parent) {
	  ...
	  if (convertView == null) {
		  ...
		  holder.authorDate.setText(threadArrayList.get(position).getAuthorDate());
			  if (favs.contains(XDADeviceSpecific.identList.get(position))) {
	      ...
	      holder.fb.setOnClickListener(new OnClickListener() {
	  		public void onClick(View v) {
	  			...
	  			author = holder.authorDate.getText().toString();
  		  	  	url = XDADeviceSpecific.entriesArray.get(position);
  		  	  	ident = XDADeviceSpecific.identList.get(position);
  		  	  	String type = XDADeviceSpecific.typeList.get(position);
